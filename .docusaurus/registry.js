export default {
  ...
  "d8224fc8": [() => import(/* webpackChunkName: "d8224fc8" */ "@site/docs/guide/getting-started.md"), "@site/docs/guide/getting-started.md", require.resolveWeak("@site/docs/guide/getting-started.md")],};
